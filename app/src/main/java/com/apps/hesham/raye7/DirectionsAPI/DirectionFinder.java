...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyDNYauCLrMocL33ggksRf4Jd3cEFV_aOgE";
    ...
    //Search using LatLngs instead of Text for better accuracy
    //(It appears as text for the user)
